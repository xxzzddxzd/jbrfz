#!/usr/bin/env python3
"""Install signed arm64 hook entry bridges in CookieRunCrumble 1.1.001.
...
DATA_SLOT_RVA = 0x0F2AF000
TRAMPOLINE_BASE_RVA = 0x0DEF4200
TARGET_STUB_SIZE = 12
...
HOOKS = (
    ("LoadingFlag.Set", 0x03BFDE3C, "ff0301d1f65701a9f44f02a9"),
    ("AfterResponse(RpcException)", 0x03A8578C, "ff8301d1f85f02a9f65703a9"),
    ("AfterError", 0x03A85C10, "ff4301d1f65702a9f44f03a9"),
    ("Guide.HandleOnGuideUIClick", 0x0426B12C, "ffc300d1f44f01a9fd7b02a9"),
    ("OvenAutoDrawService.ctor", 0x0424BC0C, "ffc301d1fc6f01a9fa6702a9"),
    ("CookieGacha.OnPageOpen", 0x040CB084, "ff4301d1f85f01a9f65702a9"),
    ("PetGacha.OnPageOpen", 0x040FFEF0, "f657bda9f44f01a9fd7b02a9"),
    ("Inventory.OnPopupOpen", 0x04174E28, "f657bda9f44f01a9fd7b02a9"),
    ("InventoryItemInfo.OnPopupOpen", 0x0416B51C, "ff4301d1f85f01a9f65702a9"),
    ("Roulette.RefreshView", 0x04AD73FC, "ff8306d1fc6f14a9fa6715a9"),
    ("SugarRune.OnPopupOpen", 0x03F4D610, "eb2bbc6de923016df44f02a9"),
    ("StellarLink.OnPageOpen", 0x043138A8, "ff0305d1fc6f0fa9f85f10a9"),
    ("CrumbleDungeon.OnPageOpen", 0x04047C80, "fc6fbaa9fa6701a9f85f02a9"),
    ("DailyDungeon.OnPageOpen", 0x040616B4, "f44fbea9fd7b01a9fd430091"),
    ("ArenaLobby.OnPageOpen", 0x04023CD4, "f44fbea9fd7b01a9fd430091"),
    ("ArenaPreparation.OnPageOpen", 0x040343CC, "f44fbea9fd7b01a9fd430091"),
    ("Requirement.Register", 0x03E64F28, "ff8301d1fa6701a9f85f02a9"),
    ("Requirement.CalculateCurrentValue", 0x03E694C8, "ff0302d1f85f04a9f65705a9"),
    ("Guide.HandleOnProgressUpdated", 0x0426BF38, "fc6fbaa9fa6701a9f85f02a9"),
    ("Guide.UpdateUI", 0x0426AA90, "ff8305d1fc6f10a9fa6711a9"),
)
